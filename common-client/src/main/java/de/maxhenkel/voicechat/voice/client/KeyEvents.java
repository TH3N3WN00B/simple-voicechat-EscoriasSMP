...
public class KeyEvents {
    ...
    public static void registerKeyBinds() {
        ...
        ALL_KEYS = new KeyMapping[]{
                KEY_PTT, KEY_WHISPER, KEY_ANNOUNCE, KEY_MUTE, KEY_DISABLE, KEY_HIDE_ICONS, KEY_VOICE_CHAT, KEY_VOICE_CHAT_SETTINGS, KEY_GROUP, KEY_TOGGLE_RECORDING, KEY_ADJUST_VOLUMES
        };
    }
